...
var testCases = [
  {
    text: 'I bomb atomically/Socrates\' philosophies and hypotheses/Can\'t define how I be droppin\' these mockeries/Lyrically perform armed robbery/Flee with the lottery/Possibly, they spotted me!',
    expected: [ 'I', 'bomb', 'atomically', 'Socrates\'', 'philosophies', 'and', 'hypotheses', 'Can\'t', 'define', 'how', 'I', 'be', 'droppin\'', 'these', 'mockeries', 'Lyrically', 'perform', 'armed', 'robbery', 'Flee', 'with', 'the', 'lottery', 'Possibly', 'they', 'spotted', 'me' ]
  },
  {
...
function runTest(testCase) {
  test(testCase.text, function basicTest(t) {
    t.deepEqual(splitToWords(testCase.text), testCase.expected, 'Words split correctly.');
    t.end();
  });
}
